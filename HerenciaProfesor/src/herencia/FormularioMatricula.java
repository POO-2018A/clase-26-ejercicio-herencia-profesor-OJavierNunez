...
public class FormularioMatricula extends javax.swing.JFrame {
    ...
    public FormularioMatricula() {
        ...
        //*********************   Tabla para Estudiantes Matriculados *********************
    ...
    private void initComponents() {
        ...
        lblSubtitulo.setText("EPN      2018-A ");
        ...
        if (!nombre.equals("")&& !apellido.equals("")&& !facultad.equals("") && !materia.equals("")){
            ...
            if(confirmacion ==0){
                ...
                if (!profesorExiste){
                    ...
                    JOptionPane.showMessageDialog(rootPane, "La materia seleccionada ya fue registrada!!");
        ...
        if (!esMatriculado.equals("")&& !materiaSelec.equals("")){
            ...
            if(confirmacion ==0){
                ...
                if (!matriculaExiste){
                    ...
                    JOptionPane.showMessageDialog(rootPane, "Estudiante ya matriculado en esa materia");
